...
public enum MarkdownDiffBuilder {
    public struct Model: Equatable {
        public let rows: [Row]
        public let isBinary: Bool

        public init(rows: [Row], isBinary: Bool) {
            self.rows = rows
    ...
    public static func build(_ diff: UnifiedDiff) -> Model {
    ...
    public static func parse(_ text: String, insideFence: Bool) -> (style: BlockStyle, content: String) {
